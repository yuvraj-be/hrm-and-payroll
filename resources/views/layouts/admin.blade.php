...
<head>
    ...
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'Payroll') }}
        ...
        <div class="footer-wrapper">
            <div class="py-1">
                <span class="text-muted">{{ __('Copyright') }} &copy;
                    {{ App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Payroll') }}
                    {{ date('Y') }}</span>
            </div>
        </div>
    </footer>
