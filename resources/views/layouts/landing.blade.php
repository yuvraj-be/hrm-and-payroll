...
<head>
    ...
    <title>
        {{ App\Models\Utility::getValByName('title_text') ? App\Models\Utility::getValByName('title_text') : config('app.name', 'Payroll ') }}
    </title>
...
<body class="{{ $color }}">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="{{ route('login') }}" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>Live
                            Demo</a>
                        <a href="https://instagram.com/belbaseyuvraj"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <img src="{{ asset('landing/hrm.png') }}" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/hrm.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    {{-- <p class="text-body"> {{ __('Copyright') }} &copy;
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Hrm') }}
                        {{ date('Y') }} </p> --}}
                    <p class="text-body"> {{ __('Copyright') }}
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Payroll') }}
                        {{ date('Y') }} | Design By Yuvraj </p>
                </div>
            </div>
        </div>
