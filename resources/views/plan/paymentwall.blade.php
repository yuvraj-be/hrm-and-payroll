...
<title>@if(Auth::user()->type == 'super admin')  {{config('app.name', 'Payroll Saas')}} @else {{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Payroll SaaS')}} @endif</title>
