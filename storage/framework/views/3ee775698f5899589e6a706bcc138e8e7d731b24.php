...
<head>
    ...
    <title>
        <?php echo e(Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'Payroll')); ?>
        ...
        <div class="footer-wrapper">
            <div class="py-1">
                <span class="text-muted"><?php echo e(__('Copyright')); ?> &copy;
                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Payroll')); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dea/resources/views/layouts/admin.blade.php ENDPATH**/ ?>