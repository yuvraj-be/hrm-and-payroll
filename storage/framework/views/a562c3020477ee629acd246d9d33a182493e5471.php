...
<head>
    ...
    <title>
        <?php echo e(App\Models\Utility::getValByName('title_text') ? App\Models\Utility::getValByName('title_text') : config('app.name', 'Payroll ')); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    <p class="text-body"> <?php echo e(__('Copyright')); ?>
                        ...
                        <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Payroll')); ?>

                        <?php echo e(date('Y')); ?> | Design By Yuvraj </p>
                </div>
            </div>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dea/resources/views/layouts/landing.blade.php ENDPATH**/ ?>